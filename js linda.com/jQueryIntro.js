...
// use jQuery (присваивание класса)
...
// find any paragraph that contain the word "packages" (находит все абзацы, содержащие слово "packages")
...
// hide all paragraphs
// скрывает все абзацы за 4сек
$("p").hide(4000);
// cкрывает соответствующие элементы путем затухания их до прозрачного состояния
$("p").fadeOut(4000);
